...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\BladeServiceProvider::boot()
         * @param mixed $haystack
         * @param mixed $searchString
         * @static 
         */ 
        public static function mark($haystack, $searchString = null)
        {
                        return \Illuminate\Support\Str::mark($haystack, $searchString);
        }
